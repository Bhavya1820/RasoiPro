    ...
    <nav className="sticky bg-black poppins-medium shadow-md p-4">
      ...
      {isOpen && (
        <div className="md:hidden flex flex-col text-white items-center mt-2 space-y-4">
          <Link to="/features" className="block py-2 hover:text-blue-500">Features</Link>
          <Link to="/pricing" className="block py-2 hover:text-blue-500">Pricing</Link>
          <Link to="/customers" className="block py-2 hover:text-blue-500">Customers</Link>
